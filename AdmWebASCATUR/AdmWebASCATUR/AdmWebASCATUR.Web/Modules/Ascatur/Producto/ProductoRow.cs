...
namespace AdmWebASCATUR.Ascatur.Entities
{
    ...
    [ConnectionKey("ASCATUR"), TableName("[dbo].[Producto]")]
    [DisplayName("Producto"), InstanceName("Producto"), TwoLevelCached]
    [ReadPermission("PermissionKeys:Comercio")]
    [ModifyPermission("PermissionKeys:Comercio")]
    [LookupScript("Ascatur:Producto")]
    public sealed class ProductoRow : Row, IIdRow, INameRow, IMultiComercioRow
    {
        ...
        [DisplayName("Imagen Primaria"), Column("Imagen_Primaria"), Size(100), ImageUploadEditor(FilenameFormat = "Producto/ImagenPrimaria/~")]
        ...
        [DisplayName("Galería Imagenes"), Column("Galeria_Imagenes"), Size(100), MultipleImageUploadEditor(FilenameFormat = "Producto/GaleriaImagenes/~")]
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public RowFields()
                : base()
            {
                LocalTextPrefix = "Ascatur.Producto";
            }
        }
    }
}
