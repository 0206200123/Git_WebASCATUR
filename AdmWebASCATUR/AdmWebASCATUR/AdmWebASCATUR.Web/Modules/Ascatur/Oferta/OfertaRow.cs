...
namespace AdmWebASCATUR.Ascatur.Entities
{
    ...
    [ConnectionKey("ASCATUR"), TableName("[dbo].[Oferta]")]
    [DisplayName("Oferta"), InstanceName("Oferta"), TwoLevelCached]
    [ReadPermission("PermissionKeys:Comercio")]
    [ModifyPermission("PermissionKeys:Comercio")]
    [LookupScript("Ascatur:Oferta")]
    public sealed class OfertaRow : Row, IIdRow, INameRow, IMultiComercioRow
    {
        ...
        [DisplayName("Imagen Primaria"), Column("Imagen_Primaria"), Size(100), ImageUploadEditor(FilenameFormat = "Oferta/ImagenPrimaria/~", CopyToHistory = true)]
        ...
        [DisplayName("Galería Imagenes"), Column("Galeria_Imagenes"), Size(100), MultipleImageUploadEditor(FilenameFormat = "Oferta/GaleriaImagenes/~")]
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public RowFields()
                : base()
            {
                LocalTextPrefix = "Ascatur.Oferta";
            }
        }
    }
}
